...
copyright = (
    "2024, Joshua Blomgren, Elizabeth Gilson, Jeffrey Jacob. Project structure based on the "
...
#
html_theme_options = {
    "github_url": "https://github.com/peptide-digest/ScienceScraper",
    "logo": {
...
man_pages = [
    (master_doc, "sciencescraper", "ScienceScraper Documentation", [author], 1)
]
